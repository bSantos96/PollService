// <copyright file="PostQuestionModelValidator.cs" company="Bruno Santos">
...
namespace MicroService.Poll.WebApi.Validations
{
    ...
    /// <summary>
    /// Validations for <see cref="PostQuestionModel"/>.
    /// </summary>
    public class PostQuestionModelValidator : AbstractValidator<PostQuestionModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostQuestionModelValidator"/> class.
        /// </summary>
        public PostQuestionModelValidator()
        {
            ...
            this.RuleForEach(x => x.Choices)
                .NotEmpty()
                .WithMessage("The choice value can't be null or empty.");
        }
    }
}
